...
**Endpoint**: \`/api/badge\`
**Description**: Generates an individual SVG badge for any of 280+ supported technologies with custom height scaling.
**Query Parameters**:
- \`name\` / \`tech\`: (Required) Technology name or identifier (e.g. \`typescript\`, \`docker\`).
