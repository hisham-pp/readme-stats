      ...
      <main className="flex w-full max-w-5xl flex-col items-center justify-center mb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-zinc-400 max-w-xl mx-auto mb-6">
            ...
            query parameter to select specific technologies, or head over to the{" "}
            <strong>
              <a href="/builder" className="text-zinc-200 underline">
                API Builder
              </a>
            </strong>{" "}
            to visually configure your URLs!
          </p>
          <a
        ...
        <section className="w-full bg-zinc-950 p-8 rounded-xl border border-zinc-800 shadow-2xl mb-12">
          ...
          <p className="text-sm text-zinc-400">
            Render your most-used languages using standard dots, detailed icons{" "}
            <code className="text-zinc-300 bg-zinc-800 px-1 py-0.5 rounded">
              ?type=icon
            </code>
            , bold badges{" "}
            ...
            , or a beautiful Treemap visualization{" "}
            <code className="text-zinc-300 bg-zinc-800 px-1 py-0.5 rounded">
              ?type=treemap-icon
            </code>{" "}
            /{" "}
        ...
        <div className="w-full flex flex-col gap-12">
          {techGroups.map((group) => {
            ...
            return (
              <section
                key={group.title}
                className="w-full bg-zinc-950 p-8 rounded-xl border border-zinc-800 shadow-2xl"
              >
                <h2 className="text-xl font-semibold text-zinc-100 mb-6 border-b border-zinc-800 pb-2">
                  {group.title}
                </h2>
