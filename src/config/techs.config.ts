...
export const techMap: Record<string, TechItem> = techStack.reduce((acc, curr) => {
  acc[curr.id] = curr;
  return acc;
}, {} as Record<string, TechItem>);

export const techGroups = Array.from(new Set(techStack.map(t => t.category))).map(category => ({
  title: category,
